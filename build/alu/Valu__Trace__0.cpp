...
void Valu___024root__trace_chg_0_sub_0(Valu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+6,(vlSelfRef.negative));
    bufp->chgBit(oldp+7,(vlSelfRef.overflow));
    bufp->chgQData(oldp+8,(vlSelfRef.alu__DOT__sum),33);
    bufp->chgQData(oldp+10,(vlSelfRef.alu__DOT__diff),33);
    bufp->chgCData(oldp+12,((0x1fU & vlSelfRef.b)),5);
}
