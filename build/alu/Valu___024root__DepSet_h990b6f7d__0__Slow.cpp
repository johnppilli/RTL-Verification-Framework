...
#endif
            VL_FATAL_MT("rtl/alu.sv", 7, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Valu___024root___ctor_var_reset(Valu___024root* vlSelf) {
    ...
    vlSelf->alu__DOT__sum = VL_SCOPED_RAND_RESET_Q(33, __VscopeHash, 15374121903532043001ull);
    vlSelf->alu__DOT__diff = VL_SCOPED_RAND_RESET_Q(33, __VscopeHash, 10430518237176827616ull);
}
