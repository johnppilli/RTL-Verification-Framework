...
#endif
            VL_FATAL_MT("rtl/arbiter.sv", 7, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Varbiter___024root___dump_triggers__ico(Varbiter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Varbiter___024root___dump_triggers__ico\n"); );
    Varbiter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Varbiter___024root___ctor_var_reset(Varbiter___024root* vlSelf) {
    ...
    vlSelf->arbiter__DOT__ptr = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 11850795542868150021ull);
    vlSelf->arbiter__DOT__winner = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 1705320380518988877ull);
    vlSelf->arbiter__DOT__unnamedblk1__DOT__unnamedblk2__DOT__idx = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 5041187676811517515ull);
    vlSelf->__Vsampled_TOP__rst_n = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 725478800516634689ull);
    vlSelf->__Vsampled_TOP__grant = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 13043320465558336911ull);
    vlSelf->__Vsampled_TOP__req = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 5704490829237611114ull);
    vlSelf->__Vsampled_TOP__valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 7796465740292935226ull);
