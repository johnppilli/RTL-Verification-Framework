...
class alignas(VL_CACHE_LINE_BYTES) Vcounter___024root final : public VerilatedModule {
  public:
    ...
    VL_IN8(enable,0,0);
    VL_OUT8(count,7,0);
    CData/*0:0*/ counter__DOT___Vpast_0_0;
    CData/*7:0*/ counter__DOT___Vpast_1_0;
    CData/*0:0*/ __Vsampled_TOP__rst_n;
    CData/*0:0*/ __Vsampled_TOP__counter__DOT___Vpast_0_0;
    CData/*7:0*/ __Vsampled_TOP__counter__DOT___Vpast_1_0;
    CData/*7:0*/ __Vsampled_TOP__count;
    CData/*0:0*/ __Vsampled_TOP__enable;
