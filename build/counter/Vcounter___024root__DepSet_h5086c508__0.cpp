...
void Vcounter___024root___eval(Vcounter___024root* vlSelf) {
    ...
    vlSelfRef.__Vsampled_TOP__counter__DOT___Vpast_0_0 
        = vlSelfRef.counter__DOT___Vpast_0_0;
    vlSelfRef.__Vsampled_TOP__counter__DOT___Vpast_1_0 
        = vlSelfRef.counter__DOT___Vpast_1_0;
    vlSelfRef.__Vsampled_TOP__count = vlSelfRef.count;
    vlSelfRef.__Vsampled_TOP__enable = vlSelfRef.enable;
...
#endif
            VL_FATAL_MT("rtl/counter.sv", 2, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("rtl/counter.sv", 2, "", "Active region did not converge.");
            }
